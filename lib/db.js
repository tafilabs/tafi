...
var doParameterizedSql = function(sConnectionType, sql, vals, callback) {
  ...
  if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
    console.log('util.js::doParameterizedSql: SQL: ' + sql + ' Values: ' + vals);
  }
  connection = createConnection(sConnectionType);
  connection.connect();
  connection.query(sql, vals, function(err, results) {
    ...
    if (err) {
      if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
        console.log('util.js::doParameterizedSql: ERROR: ');
        console.log(err);
      }
      callback(err);
      return;
...
var doParameterizedSqlSingle = function(sConnectionType, sql, vals, callback) {
  ...
  if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
    console.log('util.js::doParameterizedSqlSingle: SQL: ' + sql + ' Values: ' + vals);
  }
  connection = createConnection(sConnectionType);
  connection.connect();
  connection.query(sql, vals, function(err, results) {
    ...
    if (err) {
      if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
        console.log('util.js::doParameterizedSqlSingle: ERROR: ');
        console.log(err);
      }
      callback(err);
      return;
...
var doParameterizedInsert = function(sConnectionType, sql, vals, callback) {
  ...
  if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
    console.log('util.js::doParameterizedInsert: SQL: ' + sql + ' Values: ' + vals);
  }
  connection = createConnection(sConnectionType);
  connection.connect();
  connection.query(sql, vals, function(err, result) {
    ...
    if (err) {
      if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
        console.log('util.js::doParameterizedInsert: ERROR: ');
        console.log(err);
      }
      callback(err);
      return;
...
var doParameterizedUpdate = function(sConnectionType, sql, vals, callback) {
  ...
  if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
    console.log('util.js::doParameterizedUpdate: SQL: ' + sql + ' Values: ' + vals);
  }
  connection = createConnection(sConnectionType);
  connection.connect();
  connection.query(sql, vals, function(err, result) {
    ...
    if (err) {
      if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
        console.log('util.js::doParameterizedUpdate: ERROR: ');
        console.log(err);
      }
      callback(err);
      return;
...
var doParameterizedDelete = function(sConnectionType, sql, id, callback) {
  ...
  if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
    console.log('util.js::doParameterizedDelete: SQL: ' + sql + ' ID: ' + id);
  }
  connection = createConnection(sConnectionType);
  connection.connect();
  connection.query(sql, [id], function(err, result) {
    ...
    if (err) {
      if ( utilDbDebugLevel === UTIL_DB_DEBUG_LEVEL.ON ) {
        console.log('util.js::doParameterizedDelete: ERROR: ');
        console.log(err);
      }
      callback(err);
      return;
